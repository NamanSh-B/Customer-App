"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([[7578],{
...
/* harmony import */ var _index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-tcQvqkiX.js */ 48225);
...
const enableHideCaretOnScroll = (componentEl, inputEl, scrollEl) => {
  ...
  (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.f)(scrollEl, 'ionScrollStart', hideCaret);
  (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.f)(scrollEl, 'ionScrollEnd', showCaret);
  inputEl.addEventListener('blur', onBlur);
  return () => {
    (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.m)(scrollEl, 'ionScrollStart', hideCaret);
    (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.m)(scrollEl, 'ionScrollEnd', showCaret);
...
const enableInputBlurring = () => {
  ...
  (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.f)(doc, 'ionScrollStart', onScroll);
  doc.addEventListener('focusin', onFocusin, true);
  doc.addEventListener('touchend', onTouchend, false);
  return () => {
    (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.m)(doc, 'ionScrollStart', onScroll, true);
...
const jsSetFocus = /*#__PURE__*/function () {
  var _ref2 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (componentEl, inputEl, contentEl, footerEl, keyboardHeight, enableScrollPadding, disableClonedInput = false, platformHeight = 0, waitForResize = true) {
    ...
    if (typeof window !== 'undefined') {
      ...
      const _scrollContent = /*#__PURE__*/function () {
        var _ref3 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          ...
          if (contentEl) {
            yield (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.c)(contentEl, 0, scrollData.scrollAmount, scrollData.scrollDuration);
          }
      ...
      if (contentEl) {
        const scrollEl = yield (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.g)(contentEl);
        /**
...
const startInputShims = /*#__PURE__*/function () {
  var _ref4 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (config, platform) {
    /**
    ...
    const registerInput = /*#__PURE__*/function () {
      var _ref5 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (componentEl) {
        yield new Promise(resolve => (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.c)(componentEl, resolve));
        const inputRoot = componentEl.shadowRoot || componentEl;
        const inputEl = inputRoot.querySelector('input') || inputRoot.querySelector('textarea');
        const scrollEl = (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.f)(componentEl);
