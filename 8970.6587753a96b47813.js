...
/* harmony import */ var _helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers-HEqiOzXb.js */ 19807);
...
const _writeNavState = /*#__PURE__*/function () {
  var _ref = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (root, chain, direction, index, changed = false, animation) {
    try {
      ...
      yield new Promise(resolve => (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.c)(outlet, resolve));
...
const readNavState = /*#__PURE__*/function () {
  var _ref2 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (root) {
    const ids = [];
    let outlet;
    let node = root;
...
const nextFrame = () => new Promise(resolve => (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => resolve()));
/**
...
const findFragmentTarget = /*#__PURE__*/function () {
  var _ref3 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (fragment, shouldContinue) {
...
const scrollToFragment = /*#__PURE__*/function () {
  var _ref4 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (fragment, shouldContinue = () => true) {
    ...
    try {
      const contentHost = (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_3__.f)(target);
      if (contentHost && (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_3__.i)(contentHost)) {
        const content = contentHost;
        const scrollEl = yield (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_3__.g)(content);
...
const Router = class {
  ...
  componentDidLoad() {
    window.addEventListener('ionRouteRedirectChanged', (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.p)(this.onRedirectChanged.bind(this), 10));
    window.addEventListener('ionRouteDataChanged', (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.p)(this.onRoutesChanged.bind(this), 100));
  }
  onPopState() {
    var _this2 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  push(_x9) {
    var _this4 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (path, direction = 'forward', animation) {
      var _a;
      if (path.startsWith('.')) {
  ...
  safeWriteNavState(_x0, _x1, _x10, _x11, _x12) {
    var _this8 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, chain, direction, segments, redirectFrom, index = 0, animation) {
  ...
  runGuards() {
    var _this0 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (to = _this0.getSegments(), from) {
      if (from === undefined) {
