...
const Input = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = Object.assign(Object.assign({}, (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el)), (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.b)(this.el, ['tabindex', 'title', 'data-form-type', 'dir']));
  }
  connectedCallback() {
    const {
      el
    } = this;
    this.slotMutationController = (0,_input_utils_Y6NgW8bw_js__WEBPACK_IMPORTED_MODULE_5__.c)(el, ['label', 'start', 'end'], () => {
