...
function getDecimalPlaces(n) {
  if (!(0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.j)(n)) return 0;
  if (n % 1 === 0) return 0;
...
const Range = class {
  constructor(hostRef) {
    ...
    this.clampBounds = value => {
      return (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.e)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, this.ratioB + step, 1);
      }
  ...
  debounceChanged() {
     ...
     */
    this.ionInput = debounce === undefined ? originalIonInput !== null && originalIonInput !== void 0 ? originalIonInput : ionInput : (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.d)(ionInput, debounce);
  }
  minChanged(newValue) {
    if (!(0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.j)(newValue)) {
      this.min = 0;
    }
    if (!this.noUpdate) {
      this.updateRatio();
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el);
    // If min, max, or step are not safe, set them to 0, 100, and 1, respectively.
    // Each watch does this, but not before the initial load.
    this.min = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.j)(this.min) ? this.min : 0;
    this.max = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.j)(this.max) ? this.max : 100;
    this.step = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.j)(this.step) ? this.step : 1;
  }
  componentDidLoad() {
  ...
  connectedCallback() {
    ...
    const ionContent = (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.f)(this.el);
  ...
  onMove(detail) {
    ...
    if (contentEl && this.pressedKnob === undefined) {
      this.initialContentScrollY = (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
    /**
  ...
  onEnd(detail) {
     ...
     */
    if (contentEl && this.pressedKnob !== undefined) {
      (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialContentScrollY);
    }
  ...
  update(currentX) {
    ...
    let ratio = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, (currentX - rect.left) / rect.width, 1);
  ...
  render() {
    ...
    (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.a)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  const clampedValue = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.e)(min, value, max);
  return roundToMaxDecimalPlaces(clampedValue, min, max, step);
};
const valueToRatio = (value, min, max) => {
  return (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, (value - min) / (max - min), 1);
};
let rangeIds = 0;
Range.style = {
  ios: rangeIosCss(),
