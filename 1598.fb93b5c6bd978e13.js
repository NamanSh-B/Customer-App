...
class AddMoneyWalletPage {
  ...
  addMoney(amount, paymentType) {
    ...
    this.apiFactory.addMoneyToWallet(amount, paymentType, platformNumber).subscribe(/*#__PURE__*/function () {
      var _ref = (0,_home_namansharma_Documents_TicketSimply_capacitor_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (res) {
