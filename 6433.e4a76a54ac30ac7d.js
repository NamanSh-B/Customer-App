...
/* harmony import */ var _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./overlays-TbiM4mdr.js */ 94248);
...
/* harmony import */ var _ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ionic-global-Cp_eT4sZ.js */ 61902);
/* harmony import */ var _theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./theme-DiVJyqlX.js */ 94576);
/* harmony import */ var _index_B_dQk_WE_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-B_dQk_WE.js */ 67608);
/* harmony import */ var _animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./animation-DLJpuoEz.js */ 39145);
/* harmony import */ var _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-ZjP4CjeZ.js */ 99596);
/* harmony import */ var _hardware_back_button_B93Gru0Y_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./hardware-back-button-B93Gru0Y.js */ 86490);
...
const configureDismissInteraction = (triggerEl, triggerAction, popoverEl, parentPopoverEl) => {
  ...
  const root = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.g)(parentPopoverEl);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const focusItem = item => {
  const root = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.g)(item);
  const button = root.querySelector('button');
  if (button) {
    (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => button.focus());
  }
};
/**
...
const configureKeyboardInteraction = popoverEl => {
  const callback = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
      var _a;
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_2__.B);
    };
  ...
  connectedCallback() {
    ...
    (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_2__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (_b = (_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_2__.k)(el);
  ...
  componentDidLoad() {
    ...
    if (parentPopover) {
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.f)(parentPopover, 'ionPopoverWillDismiss', () => {
  ...
  presentFromTrigger(_x3) {
    var _this = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, focusDescendant = false) {
  ...
  present(event) {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_FnPGymXL_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, el, _this2.component, ['popover-viewport'], _this2.componentProps, inline);
      ...
      if ((0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.h)(el)) {
        yield (0,_index_B_dQk_WE_js__WEBPACK_IMPORTED_MODULE_8__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_B_dQk_WE_js__WEBPACK_IMPORTED_MODULE_8__.w)();
      }
      yield (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_2__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_2__.n)(el);
      }
      unlock();
    })();
  }
  ...
  recalculateContentOnHeaderReady() {
    ...
    this.headerResizeObserver = new ResizeObserver(/*#__PURE__*/(0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
  ...
  dismiss(_x4, _x5) {
    var _this4 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data, role, dismissParentPopover = true) {
      ...
      const shouldDismiss = yield (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_2__.g)(_this4, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this4.event);
      if (shouldDismiss) {
        if (destroyKeyboardInteraction) {
          destroyKeyboardInteraction();
        ...
        yield (0,_framework_delegate_FnPGymXL_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this4.usersElement);
      }
      unlock();
   ...
   */
  onDidDismiss() {
    return (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      class: Object.assign(Object.assign({}, (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.cssClass)), {
        ...
        [_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_2__.F]: focusTrap === false,
