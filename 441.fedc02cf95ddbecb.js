...
/* harmony import */ var _index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index-tcQvqkiX.js */ 48225);
/* harmony import */ var _index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-MEDq2S8l.js */ 69284);
/* harmony import */ var _framework_delegate_FnPGymXL_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./framework-delegate-FnPGymXL.js */ 45245);
/* harmony import */ var _helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers-HEqiOzXb.js */ 19807);
...
/* harmony import */ var _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./overlays-TbiM4mdr.js */ 94248);
/* harmony import */ var _theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./theme-DiVJyqlX.js */ 94576);
/* harmony import */ var _index_B_dQk_WE_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-B_dQk_WE.js */ 67608);
/* harmony import */ var _ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ionic-global-Cp_eT4sZ.js */ 61902);
/* harmony import */ var _keyboard_ywgs5efA_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./keyboard-ywgs5efA.js */ 13224);
/* harmony import */ var _animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./animation-DLJpuoEz.js */ 39145);
...
/* harmony import */ var _hardware_back_button_B93Gru0Y_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./hardware-back-button-B93Gru0Y.js */ 86490);
...
const StatusBar = {
  ...
  getStyle: function () {
    var _ref = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const engine = this.getEngine();
      if (!engine) {
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref2 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
     ...
     */
    const shouldDismiss = yield el.canDismiss(undefined, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.G);
    if (!shouldDismiss) {
      return;
    }
    /**
...
const createSwipeToCloseGesture = (el, animation, statusBarStyle, onDismiss, onDragStart, onDragMove, onDragEnd) => {
  ...
  let lastStep = 0;
  const getScrollY = () => {
    if (contentEl && (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl)) {
  ...
  const canStart = detail => {
     ...
     */
    contentEl = (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.f)(target);
    if (contentEl) {
      /**
       ...
       * asynchronous.
       */
      if ((0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl)) {
        const root = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl);
  ...
  const onStart = detail => {
    ...
    if (deltaY > 0 && contentEl) {
      (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
  ...
  const onMove = detail => {
    ...
    const clampedStep = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.e)(0.0001, processedStep, maxStep);
  ...
  const onEnd = detail => {
    ...
    if (contentEl) {
      (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialScrollY);
    }
    animation.onFinish(() => {
      if (!shouldComplete) {
        gesture.enable(true);
  ...
  const gesture = (0,_index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_14__.createGesture)({
    ...
    gesturePriority: _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.O,
    direction: 'y',
    threshold: 10,
    canStart,
    onStart,
...
const computeDuration = (remaining, velocity) => {
  return (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.e)(400, remaining / Math.abs(velocity * 1.1), 500);
};
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
  const {
    wrapperAnimation,
    backdropAnimation,
    contentAnimation
  ...
  if (presentingEl) {
    ...
    const presentingElRoot = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
...
const createSheetGesture = (baseEl, backdropEl, wrapperEl, initialBreakpoint, backdropBreakpoint, animation, breakpoints = [], expandToScroll, getCurrentBreakpoint, onDismiss, onBreakpointChange, onDragStart, onDragMove, onDragEnd) => {
  ...
  const enableBackdrop = () => {
     ...
     * the sheet.
     */
    baseEl.classList.remove(_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.F);
  };
  const disableBackdrop = () => {
     ...
     */
    baseEl.classList.add(_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.F);
  };
  /**
  ...
  const canStart = detail => {
     ...
     */
    const contentEl = (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.f)(detail.event.target);
    ...
    if (!expandToScroll && contentEl) {
      const scrollEl = (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl) ? (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl).querySelector('.inner-scroll') : contentEl;
  ...
  const onStart = detail => {
     ...
     */
    if (!expandToScroll) {
      const targetEl = (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.f)(detail.event.target);
      cachedScrollEl = targetEl && (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.i)(targetEl) ? (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.g)(targetEl).querySelector('.inner-scroll') : targetEl;
    }
    /**
    ...
    (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => {
      /**
  ...
  const onMove = detail => {
    ...
    offset = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.e)(0.0001, processedStep, maxStep);
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.triggerController = (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.e)();
    this.coreDelegate = (0,_framework_delegate_FnPGymXL_js__WEBPACK_IMPORTED_MODULE_3__.C)();
    ...
    this.onBackdropTap = () => {
      ...
      this.dismiss(undefined, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.B);
    };
  ...
  connectedCallback() {
    ...
    (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.j)(el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.b)(el, attributesToInherit);
    ...
    if (!((_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id)) {
      (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.k)(this.el);
    }
  }
  componentDidLoad() {
    /**
     ...
     */
    if (this.isOpen === true) {
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => this.present());
    }
  ...
  present() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_FnPGymXL_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, el, _this2.component, ['ion-page'], _this2.componentProps, inline);
      /**
       ...
       */
      if ((0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.h)(el)) {
        yield (0,_index_B_dQk_WE_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_B_dQk_WE_js__WEBPACK_IMPORTED_MODULE_9__.w)();
      }
      ...
      yield (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.f)(_this2, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
  ...
  initSwipeToClose() {
    ...
    const contentEl = (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.a)(el);
    if (!contentEl) {
      (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_2__.p)(el);
      return;
    }
  ...
  sheetOnDismiss() {
    ...
    this.animation.onFinish(/*#__PURE__*/(0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this3.currentBreakpoint = 0;
      _this3.ionBreakpointDidChange.emit({
        breakpoint: _this3.currentBreakpoint
      });
      yield _this3.dismiss(undefined, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.G);
  ...
  cardOnDismiss() {
    ...
    this.animation.onFinish(/*#__PURE__*/(0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this4.dismiss(undefined, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.G);
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
      if (_this5.gestureAnimationDismissing && role !== _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.G) {
        return false;
      }
      ...
      const dismissed = yield (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.g)(_this5, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
        presentingEl: presentingElement,
      ...
      if (dismissed) {
        ...
        yield (0,_framework_delegate_FnPGymXL_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this5.usersElement);
   ...
   */
  onDidDismiss() {
    return (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.h)(this.el, 'ionModalDidDismiss');
  }
  /**
   * Returns a promise that resolves when the modal will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.h)(this.el, 'ionModalWillDismiss');
  }
  /**
  ...
  handleViewTransition() {
    ...
    transitionAnimation.play().then(() => {
      ...
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => this.updateSafeAreaOverrides());
  ...
  ensureCorrectModalPosition() {
    ...
    const root = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.g)(el);
  ...
  dismissNestedModals() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      nestedModals === null || nestedModals === void 0 ? void 0 : nestedModals.forEach(/*#__PURE__*/function () {
        var _ref5 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (modal) {
  ...
  render() {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      class: Object.assign({
        ...
        'overlay-hidden': true,
        [_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_7__.F]: focusTrap === false
      ...
      key: '5ba6315c7c8c64fa04c62f85fd493da5275b2cbd',
      ref: el => this.backdropEl = el,
      visible: this.showBackdrop,
      tappable: this.backdropDismiss,
      part: "backdrop"
    }), mode === 'ios' && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'a76c48d41c67f86c18a7481e980e6925e614f85d',
      class: "modal-shadow"
      ...
      */
      ...
      key: '2dfaaebe3d0b2a46be1224c25f9ab89bf1744332',
