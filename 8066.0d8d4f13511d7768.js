...
const Radio = class {
  ...
  connectedCallback() {
    ...
    if (radioGroup) {
      this.updateState();
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.f)(radioGroup, 'ionValueChange', this.updateState);
    }
  }
  disconnectedCallback() {
    const radioGroup = this.radioGroup;
    if (radioGroup) {
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.m)(radioGroup, 'ionValueChange', this.updateState);
      this.radioGroup = null;
    }
  }
  get hasLabel() {
...
const RadioGroup = class {
  ...
  render() {
    ...
    const mode = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_5__.b)(this);
    (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.a)(true, el, name, value, false);
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
