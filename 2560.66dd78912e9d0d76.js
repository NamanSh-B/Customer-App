...
const SegmentButton = class {
  ...
  connectedCallback() {
    ...
    if (segmentEl) {
      this.updateState();
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.f)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.f)(segmentEl, 'ionStyle', this.updateStyle);
    }
  ...
  disconnectedCallback() {
    ...
    if (segmentEl) {
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.m)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.m)(segmentEl, 'ionStyle', this.updateStyle);
      this.segmentEl = null;
    }
  }
  componentWillLoad() {
    this.inheritedAttributes = Object.assign({}, (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.b)(this.el, ['aria-label']));
