...
const Accordion = class {
  constructor(hostRef) {
    ...
    this.setAria = (expanded = false) => {
       ...
       */
      const root = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.g)(ionItem);
    ...
    this.expandAccordion = () => {
      ...
      if (this.shouldAnimate()) {
        (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => {
          this.state = 8 /* AccordionState.Expanding */;
          this.currentRaf = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.r)(/*#__PURE__*/(0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            const contentHeight = contentElWrapper.offsetHeight;
            const waitForTransition = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.t)(contentEl, 2000);
    ...
    this.collapseAccordion = () => {
      ...
      if (this.shouldAnimate()) {
        this.currentRaf = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.r)(/*#__PURE__*/(0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          ...
          contentEl.style.setProperty('max-height', `${contentHeight}px`);
          (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.r)(/*#__PURE__*/(0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            const waitForTransition = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.t)(contentEl, 2000);
    ...
    this.updateState = /*#__PURE__*/(0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  connectedCallback() {
    ...
    if (accordionGroupEl) {
      this.updateState();
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.f)(accordionGroupEl, 'ionValueChange', this.accordionGroupUpdateHandler);
    }
  }
  disconnectedCallback() {
    const accordionGroupEl = this.accordionGroupEl;
    if (accordionGroupEl) {
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_2__.m)(accordionGroupEl, 'ionValueChange', this.accordionGroupUpdateHandler);
    }
  }
  componentDidLoad() {
    this.setItemDefaults();
