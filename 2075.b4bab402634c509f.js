...
/* harmony import */ var _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlays-TbiM4mdr.js */ 94248);
...
/* harmony import */ var _hardware_back_button_B93Gru0Y_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./hardware-back-button-B93Gru0Y.js */ 86490);
/* harmony import */ var _helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helpers-HEqiOzXb.js */ 19807);
/* harmony import */ var _index_Q6UPU0Ay_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-Q6UPU0Ay.js */ 84359);
...
/* harmony import */ var _framework_delegate_FnPGymXL_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./framework-delegate-FnPGymXL.js */ 45245);
/* harmony import */ var _animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./animation-DLJpuoEz.js */ 39145);
...
const Menu = class {
  constructor(hostRef) {
    ...
    this.handleFocus = ev => {
       ...
       */
      const lastOverlay = (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_3__.o)(document);
  ...
  sideChanged() {
    this.isEndSide = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_6__.o)(this.side);
    /**
  ...
  connectedCallback() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _index_Q6UPU0Ay_js__WEBPACK_IMPORTED_MODULE_7__.m._register(_this);
      _this.menuChanged();
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el);
  }
  componentDidLoad() {
    var _this2 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  disconnectedCallback() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _index_Q6UPU0Ay_js__WEBPACK_IMPORTED_MODULE_7__.m._unregister(_this3);
      if (_this3.animation) {
  ...
  onBackdropClick(ev) {
    ...
    if (this._isOpen && this.lastOnEnd < ev.timeStamp - 100) {
      ...
      if (shouldClose) {
        ev.preventDefault();
        ev.stopPropagation();
        this.close(undefined, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_3__.B);
      }
    }
  }
  onKeydown(ev) {
  ...
  setOpen(shouldOpen, animated = true, role) {
    ...
    return _index_Q6UPU0Ay_js__WEBPACK_IMPORTED_MODULE_7__.m._setOpen(this, shouldOpen, animated, role);
  }
  trapKeyboardFocus(ev, doc) {
    ...
    if (this.el.contains(target)) {
       ...
       * here to avoid that.
       */
      (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_3__.n)(el);
      /**
      ...
      if (this.lastFocus === doc.activeElement) {
        (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_3__.q)(el);
      }
    }
  }
  _setOpen(_x) {
    var _this4 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (shouldOpen, animated = true, role) {
  ...
  loadAnimation() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
       ...
       * If the document direction changes, we need to create a new animation.
       */
      const isEndSide$1 = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_6__.o)(_this5.side);
      ...
      const animation = _this5.animation = yield _index_Q6UPU0Ay_js__WEBPACK_IMPORTED_MODULE_7__.m._createAnimation(_this5.type, _this5);
  ...
  canStart(detail) {
    ...
    if (this._isOpen) {
      return true;
    } else if (_index_Q6UPU0Ay_js__WEBPACK_IMPORTED_MODULE_7__.m._getOpenSync()) {
      return false;
    }
    return checkEdgeSide(window, detail.currentX, this.isEndSide, this.maxEdgeStart);
  }
  onWillStart() {
    this.beforeAnimation(!this._isOpen, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_3__.G);
    return this.loadAnimation();
  }
  onStart() {
    if (!this.isAnimating || !this.animation) {
      (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_6__.l)(false, 'isAnimating has to be true');
      return;
    }
  ...
  onEnd(detail) {
     ...
     */
    newStepValue += (0,_cubic_bezier_hHmYLOfE_js__WEBPACK_IMPORTED_MODULE_2__.g)([0, 0], [0.4, 0], [0.6, 1], [1, 1], (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_6__.e)(0, adjustedStepValue, 0.9999))[0] || 0;
    const playTo = this._isOpen ? !shouldComplete : shouldComplete;
    this.animation.easing('cubic-bezier(0.4, 0.0, 0.6, 1)').onFinish(() => this.afterAnimation(shouldOpen, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_3__.G), {
      oneTimeCallback: true
    }).progressEnd(playTo ? 1 : 0, this._isOpen ? 1 - newStepValue : newStepValue, 300);
  }
  beforeAnimation(shouldOpen, role) {
    (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_6__.l)(!this.isAnimating, '_before() should not be called while animating');
    /**
  ...
  updateState() {
    ...
    if (!isActive) {
       ...
       */
      this.afterAnimation(false, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_3__.G);
    }
  }
  render() {
    const {
...
const updateVisibility = /*#__PURE__*/function () {
  var _ref = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (menu) {
    const menuEl = yield _index_Q6UPU0Ay_js__WEBPACK_IMPORTED_MODULE_7__.m.get(menu);
...
const MenuButton = class {
  constructor(hostRef) {
     ...
     */
    this.type = 'button';
    this.onClick = /*#__PURE__*/(0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _index_Q6UPU0Ay_js__WEBPACK_IMPORTED_MODULE_7__.m.toggle(_this7.menu);
    });
  }
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el);
...
const MenuToggle = class {
  constructor(hostRef) {
    ...
    this.autoHide = true;
    this.onClick = () => {
      return _index_Q6UPU0Ay_js__WEBPACK_IMPORTED_MODULE_7__.m.toggle(this.menu);
    };
  }
  connectedCallback() {
    this.visibilityChanged();
