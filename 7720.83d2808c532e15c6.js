...
/* harmony import */ var _hardware_back_button_B93Gru0Y_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hardware-back-button-B93Gru0Y.js */ 86490);
/* harmony import */ var _ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ionic-global-Cp_eT4sZ.js */ 61902);
...
/* harmony import */ var _index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-MEDq2S8l.js */ 69284);
...
/* harmony import */ var _framework_delegate_FnPGymXL_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./framework-delegate-FnPGymXL.js */ 45245);
...
/* harmony import */ var _index_B_dQk_WE_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-B_dQk_WE.js */ 67608);
...
const App = class {
  ...
  componentDidLoad() {
    var _this = this;
    {
      this.rIC(/*#__PURE__*/(0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        ...
        if (!_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('_testing')) {
          __webpack_require__.e(/*! import() */ 3850).then(__webpack_require__.bind(__webpack_require__, /*! ./index-BRHzoo00.js */ 23850)).then(module => module.startTapClick(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e));
        }
        if (_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('statusTap', isHybrid)) {
          __webpack_require__.e(/*! import() */ 873).then(__webpack_require__.bind(__webpack_require__, /*! ./status-tap-Kan2W7sh.js */ 873)).then(module => module.startStatusTap());
        }
        if (_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('inputShims', needInputShims())) {
          ...
          __webpack_require__.e(/*! import() */ 7578).then(__webpack_require__.bind(__webpack_require__, /*! ./input-shims-D10mwcw1.js */ 75197)).then(module => module.startInputShims(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e, platform));
        }
        const hardwareBackButtonModule = yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./hardware-back-button-B93Gru0Y.js */ 86490));
...
const Content = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el);
  }
  connectedCallback() {
     ...
     */
    if ((0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.h)(this.el)) {
      /**
  ...
  getScrollElement() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
       ...
       */
      if (!_this4.scrollEl) {
        yield new Promise(resolve => (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.c)(_this4.el, resolve));
      }
  ...
  getBackgroundElement() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this5.backgroundContentEl) {
        yield new Promise(resolve => (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.c)(_this5.el, resolve));
      }
  ...
  scrollToBottom() {
    var _this6 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (duration = 0) {
  ...
  scrollToPoint(_x, _x2) {
    var _this8 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (x, y, duration = 0) {
...
const handleFooterFade = (scrollEl, baseEl) => {
  (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => {
    ...
    const scale = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.e)(0, 1 - distanceToStart / fadeDuration, 1);
  ...
  constructor(hostRef) {
    ...
    this.checkCollapsibleFooter = () => {
      ...
      if (hasFade) {
        ...
        const contentEl = pageEl ? (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_7__.a)(pageEl) : null;
        if (!contentEl) {
          (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_7__.p)(this.el);
          return;
        }
    ...
    this.setupFadeFooter = /*#__PURE__*/function () {
      var _ref2 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl) {
        const scrollEl = _this9.scrollEl = yield (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_7__.g)(contentEl);
        /**
  ...
  connectedCallback() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const promise = (0,_keyboard_controller_BaaVITYt_js__WEBPACK_IMPORTED_MODULE_8__.c)(/*#__PURE__*/function () {
        var _ref3 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (keyboardOpen, waitForResize) {
          /**
...
const handleContentScroll = (scrollEl, scrollHeaderIndex, contentEl) => {
  (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => {
    const scrollTop = scrollEl.scrollTop;
    const scale = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.e)(1, 1 + -scrollTop / 500, 1.1);
...
const handleHeaderFade = (scrollEl, baseEl, condenseHeader) => {
  (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => {
    ...
    const distanceToStart = scrollTop - fadeStart;
    const fadeDuration = 10;
    const scale = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.e)(0, distanceToStart / fadeDuration, 1);
    (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => {
...
const Header = class {
  constructor(hostRef) {
    ...
    this.setupFadeHeader = /*#__PURE__*/function () {
      var _ref4 = (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl, condenseHeader) {
        const scrollEl = _this1.scrollEl = yield (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_7__.g)(contentEl);
        /**
         * Handle fading of toolbars on scroll
         */
  ...
  checkCollapsibleHeader() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (hasCondense) {
        ...
        const contentEl = pageEl ? (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_7__.a)(pageEl) : null;
        if (!contentEl) {
          (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_7__.p)(_this10.el);
          return;
        }
  ...
  setupCondenseHeader(contentEl, pageEl) {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!contentEl || !pageEl) {
        (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_7__.p)(_this11.el);
        return;
      }
      if (typeof IntersectionObserver === 'undefined') {
        return;
      }
      _this11.scrollEl = yield (0,_index_MEDq2S8l_js__WEBPACK_IMPORTED_MODULE_7__.g)(contentEl);
...
const RouterOutlet = class {
  ...
  connectedCallback() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this12.gesture = (yield __webpack_require__.e(/*! import() */ 2076).then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-DQ1q5MgD.js */ 98900))).createSwipeBackGesture(_this12.el, () => !_this12.gestureOrAnimationInProgress && !!_this12.swipeHandler && _this12.swipeHandler.canStart(), () => onStart(), step => {
        var _a;
  ...
  setRoot(component, params, opts) {
    var _this16 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this16.activeComponent === component && (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.s)(params, _this16.activeParams)) {
        return false;
      }
      // attach entering view to DOM
      const leavingEl = _this16.activeEl;
      const enteringEl = yield (0,_framework_delegate_FnPGymXL_js__WEBPACK_IMPORTED_MODULE_10__.a)(_this16.delegate, _this16.el, component, ['ion-page', 'ion-page-invisible'], params);
      ...
      yield (0,_framework_delegate_FnPGymXL_js__WEBPACK_IMPORTED_MODULE_10__.d)(_this16.delegate, leavingEl);
      return true;
    })();
  }
  transition(_x8, _x9) {
    var _this17 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (enteringEl, leavingEl, opts = {}) {
      ...
      yield (0,_index_B_dQk_WE_js__WEBPACK_IMPORTED_MODULE_12__.t)(Object.assign(Object.assign({
        mode,
        animated,
        enteringEl,
        leavingEl,
         ...
         * loaded bundle.
         */
        deepWait: (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_4__.h)(el),
