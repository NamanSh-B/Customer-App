...
/* harmony import */ var _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./overlays-TbiM4mdr.js */ 94248);
/* harmony import */ var _theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./theme-DiVJyqlX.js */ 94576);
/* harmony import */ var _ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ionic-global-Cp_eT4sZ.js */ 61902);
/* harmony import */ var _animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./animation-DLJpuoEz.js */ 39145);
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.g)(baseEl);
...
const createSwipeToDismissGesture = (el, toastPosition, onDismiss) => {
   ...
   */
  const wrapperEl = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector('.toast-wrapper');
  ...
  const gesture = (0,_index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_10__.createGesture)({
    ...
    gesturePriority: _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.O,
    /**
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.delegateController = (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.d)(this);
    this.lockController = (0,_lock_controller_B_hirT0v_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    this.triggerController = (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.e)();
    ...
    this.dispatchCancelHandler = ev => {
      ...
      if ((0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.i)(role)) {
    ...
    this.createSwipeGesture = toastPosition => {
      const gesture = this.gesture = createSwipeToDismissGesture(this.el, toastPosition, () => {
         ...
         */
        this.dismiss(undefined, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.G);
      });
      gesture.enable(true);
    };
    /**
  ...
  connectedCallback() {
    (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.j)(this.el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    ...
    if (!((_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id)) {
      (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.k)(this.el);
    }
  }
  componentDidLoad() {
    /**
  ...
  present() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, {
        position,
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation,
      /**
   ...
   */
  onDidDismiss() {
    return (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  callButtonHandler(button) {
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          const rtn = yield (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.s)(button.handler);
          if (rtn === false) {
...
const buttonPart = button => {
  return (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.i)(button.role) ? 'button cancel' : 'button';
};
Toast.style = {
  ios: toastIosCss(),
  md: toastMdCss()
