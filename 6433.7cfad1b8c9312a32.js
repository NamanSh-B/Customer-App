  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,_home_namansharma_Documents_TicketSimply_capacitor_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const configureKeyboardInteraction = popoverEl => {
  const callback = /*#__PURE__*/function () {
    var _ref2 = (0,_home_namansharma_Documents_TicketSimply_capacitor_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
      var _a;
...
const Popover = class {
  ...
  presentFromTrigger(_x3) {
    var _this = this;
    return (0,_home_namansharma_Documents_TicketSimply_capacitor_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, focusDescendant = false) {
  ...
  recalculateContentOnHeaderReady() {
    ...
    this.headerResizeObserver = new ResizeObserver(/*#__PURE__*/(0,_home_namansharma_Documents_TicketSimply_capacitor_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
  ...
  dismiss(_x4, _x5) {
    var _this4 = this;
    return (0,_home_namansharma_Documents_TicketSimply_capacitor_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data, role, dismissParentPopover = true) {
