...
/* harmony import */ var _button_active_BSpTQmS9_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./button-active-BSpTQmS9.js */ 29452);
...
const ActionSheet = class {
  constructor(hostRef) {
    ...
    this.isOpen = false;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.B);
    };
  ...
  present() {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
      unlock();
    })();
  }
  /**
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
      if (dismissed) {
   ...
   */
  onDidDismiss() {
    return (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionActionSheetDidDismiss');
  }
  /**
   ...
   */
  onWillDismiss() {
    return (0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionActionSheetWillDismiss');
  }
  buttonClick(button) {
    var _this3 = this;
    return (0,_Users_namansharna_Documents_Projects_capacitor_customer_app_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  getRadioButtons() {
    return this.getButtons().filter(b => {
      ...
      return role === 'radio' && !(0,_overlays_TbiM4mdr_js__WEBPACK_IMPORTED_MODULE_5__.i)(role);
    });
  }
  /**
  ...
  componentDidLoad() {
    ...
    if (!this.gesture && (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_7__.b)(this) === 'ios' && wrapperEl && groupEl) {
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => {
        ...
        if (!isScrollable) {
          this.gesture = (0,_button_active_BSpTQmS9_js__WEBPACK_IMPORTED_MODULE_2__.c)(wrapperEl, refEl => refEl.classList.contains('action-sheet-button'));
